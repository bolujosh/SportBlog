        ...
        <div className="col-md-6 col-sm-6 read-post my-3 mx-3 d-flex">
            <div className="read-post-body d-flex">
                <div className="read-head d-flex">
                    <div className="read-post-title my-2 mx-2 text-dark d-flex">{title}</div>
                    <div className="read-post-category my-2 mx-2 text-dark d-flex">{category}</div>
                </div>
                <div className="read-post-subject my-2 mx-2 text-dark d-flex">{subject}</div>
                <div className="read-post-add-img d-flex">
